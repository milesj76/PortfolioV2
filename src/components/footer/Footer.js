...
const Footer = () => {
  ...
  return (
    <footer id='footer'>
      <div className='footer-div footer-text'>
        <p>Site built by Miles Burke</p>
        <p>This site was made using React</p>
      </div>
      <div className='footer-div'>
        <a href={emailAddress} rel='noopener noreferrer' target='_blank'>
          <MailIcon className='footer-icon' />
        </a>
        <a href={githubPage} rel='noopener noreferrer' target='_blank'>
